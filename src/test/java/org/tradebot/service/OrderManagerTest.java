...
//import static org.tradebot.util.Settings.AUTOCLOSE_POSITION_TASK_KEY;
//import static org.tradebot.util.Settings.POSITION_LIVE_TIME;
//
////TODO
...
//        orderManager = new OrderManager(new HttpClient("", ""));
//    }
//
//    @Test
...
//        verify(taskManager, times(1)).schedule(
//                eq(AUTOCLOSE_POSITION_TASK_KEY),
//                any(Runnable.class),
