...
//import static org.tradebot.util.Settings.COMPLETE_TIME_MODIFICATOR;
//import static org.tradebot.util.Settings.MIN_COMPLETE_TIME;
//
...
//        verify(mockCallback, times(1)).notifyImbalanceStateUpdate(eq(20000L), any(), eq(ImbalanceService.State.PROGRESS), any());
//        verify(mockCallback, times(1)).notifyImbalanceStateUpdate(eq(23000L), any(), eq(ImbalanceService.State.POTENTIAL_END_POINT), any());
