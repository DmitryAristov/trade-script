...
//import static org.tradebot.util.Settings.CHECK_ORDERS_API_MODE_TASK_KEY;
//
////TODO
//class StrategyTest {
...
//
//        strategy.notifyImbalanceStateUpdate(1000L, null, ImbalanceService.State.POTENTIAL_END_POINT, imbalance);
//
...
//        strategy.notifyWebsocketStateChanged(true);
//
//        verify(taskManager).cancel(eq(CHECK_ORDERS_API_MODE_TASK_KEY));
//    }
//
//    @Test
